from GoogLeNet_train import train
from GoogLeNet_utils import plot_history1,plot_history2,cal_time,write_result
from GoogLeNet_test import  AccuracyAll,AccuracySim,ShowPart
import time
